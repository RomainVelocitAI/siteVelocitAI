...
const navigation = {
  solutions: [
    { name: 'Automatisation des tâches', href: '/solutions#automatisation' },
    { name: 'Intégration de systèmes', href: '/solutions#integration' },
    { name: 'Automatisation marketing', href: '/solutions#marketing' },
  ],
  support: [
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-400 text-base">
              Automatisez vos processus métier et gagnez en productivité avec nos solutions sur mesure.
            </p>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} AutoM8. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
