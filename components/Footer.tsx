...
const navigation = {
  solutions: [
    { name: 'Automatisation des tâches', href: '/#solutions' },
    { name: 'Chatbots IA', href: '/#solutions' },
    { name: 'Intégration de systèmes', href: '/#solutions' },
  ],
  support: [
...
const Footer = () => {
  return (
    <footer className="bg-gray-800 dark:bg-gray-950 text-gray-300 dark:text-gray-400 transition-colors duration-300" aria-labelledby="footer-heading">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-base">
              Automatisez votre entreprise avec l'IA. Solutions sur mesure pour doubler votre productivité à La Réunion.
            </p>
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300 transition-colors duration-200">
        ...
        <div className="mt-12 border-t border-gray-700 dark:border-gray-800 pt-8">
          <p className="text-base text-gray-400 dark:text-gray-500 text-center">
            &copy; {new Date().getFullYear()} VelocitAI. Tous droits réservés. Automatisation d'entreprise à La Réunion.
          </p>
        </div>
      </div>
    </footer>
