...
const solutions = [
  {
    ...
    icon: <CpuChipIcon className="h-12 w-12 text-indigo-600" />,
  ...
  },
  {
    ...
    icon: <ChatBubbleLeftRightIcon className="h-12 w-12 text-green-600" />,
    ...
    >
      <div className="relative w-full h-full" style={{ perspective: '1000px' }}>
        ...
        >
          {/* Face avant */}
          <div 
            className="w-full h-full bg-white rounded-2xl shadow-lg flex flex-col overflow-hidden absolute"
            style={{ backfaceVisibility: 'hidden', transform: 'rotateY(0deg)' }}
          >
            <div className="p-6 flex-1 flex flex-col">
              <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl ${solution.bgColor} mb-6`}>
            ...
            {/* Bande d'instruction */}
            <div className="bg-indigo-600 text-white py-3 px-4 text-center mt-auto">
          ...
          {/* Face arrière */}
          <div 
            className="w-full h-full bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl shadow-lg flex flex-col overflow-hidden absolute"
            ...
            <div className="p-6 flex-1 flex flex-col text-white">
              ...
              <div className="mt-auto pt-6">
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-white text-indigo-600 py-3 px-6 rounded-lg font-medium hover:shadow-lg transition-all duration-300 block text-center"
                >
                  {solution.ctaText}
                </motion.a>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 px-8 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
          >
